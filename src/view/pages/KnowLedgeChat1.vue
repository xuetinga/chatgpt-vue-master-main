<template>
    <el-container class="main-bg">
        ...
        <el-container class="parent-container">
            <el-main style="">
                <el-header style="text-align: center; line-height: 40px; margin-top:0px; ">
                    Yoka: 助力安全生产的强大知识管家
                </el-header>
                <el-container class="container-bg">
                    ...
                    <el-aside class="aside-container">
                        ...
                        <el-menu @select="handleSelect"
                            style="background-color: #d8e6ff; justify-content: center;  height:70vh; margin-bottom:20px; overflow-x: hidden; ">
...
.main-bg {
    ...
    justify-content: center;
    align-items: center;
    background: linear-gradient(135deg, #eef4ff, #f2fbff);
